...
<head>
    ...
    <title>About Us - Productivity Guys</title>
    <?php include_once 'templates/head.php'; ?>
    
    <meta name="description" content="About Us. Learn about digital marketing, design, coding, & everything productivity. Productivity Guys blog is here to help entrepreneurs exapand their skillset and improve.">
</head>
<body>
<main id="app">
<h1 class="hidden">About Productivity Guys</h1>
